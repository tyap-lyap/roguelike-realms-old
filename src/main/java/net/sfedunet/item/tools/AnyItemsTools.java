...
public class AnyItemsTools {
    ...
    public static final Item ECHSEROCK_AXE = add("echserock_axe", new BaseAxeItem(AnyToolMaterials.ECHSEROCK_TOOL_MATERIAL, 0, 0));
    public static final Item ECHSEROCK_SHOVEL = add("echserock_shovel", new BaseShovelItem(AnyToolMaterials.ECHSEROCK_TOOL_MATERIAL, 0, 0));
    public static final Item ECHSEROCK_HOE = add("echserock_hoe", new BaseHoeItem(AnyToolMaterials.ECHSEROCK_TOOL_MATERIAL, 0, 0));
