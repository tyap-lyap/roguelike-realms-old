...
public class DragonWillowFoliagePlacer extends FoliagePlacer {
    ...
    public static final Codec<DragonWillowFoliagePlacer> CODEC = RecordCodecBuilder.create(instance ->
            fillFoliagePlacerFields(instance).apply(instance, DragonWillowFoliagePlacer::new));

    public DragonWillowFoliagePlacer(UniformIntDistribution radius, UniformIntDistribution offset) {
        super(radius, offset);
    }
