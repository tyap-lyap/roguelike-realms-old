...
public class AnyItemsConfiguredFeatures {
    ...
    public static class Configs {
        public static final TreeFeatureConfig DRAGONWOOD_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(AnyItemsBlocks.DRAGON_WOOD.getDefaultState()), new SimpleBlockStateProvider(AnyItemsBlocks.DRAGON_LEAVES1.getDefaultState()), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
        public static final TreeFeatureConfig DRAGONWOODTWO_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(AnyItemsBlocks.DRAGON_WOOD.getDefaultState()), new SimpleBlockStateProvider(AnyItemsBlocks.DRAGON_LEAVES2.getDefaultState()), new BlobFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
