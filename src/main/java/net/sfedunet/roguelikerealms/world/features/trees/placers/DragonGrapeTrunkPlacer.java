...
public class DragonGrapeTrunkPlacer extends TrunkPlacer {

    public static final Codec<DragonGrapeTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            method_28904(instance).apply(instance, DragonGrapeTrunkPlacer::new));

    public DragonGrapeTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return RoguelikeRealmsTrees.DRAGON_GRAPE_TRUNK;
    }
