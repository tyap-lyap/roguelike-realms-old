package net.sfedunet.roguelikerealms.entity.model;
...
public class InferiorDragonEntityModel<T extends MobEntity> extends PlayerEntityModel<T> {

    public InferiorDragonEntityModel() {
        super(0, false);
        textureWidth = 128;
        textureHeight = 128;
